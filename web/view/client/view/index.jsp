	...
	<div class="wrapper">
				...
				<ul>
					...
					<li class="revolution-mch-1" data-transition="fade"
						...
						<div class="tp-caption revolution-ch1 sft start" data-x="center"
							...
							data-endspeed="300">
							 <br> <strong>Bộ sưu tập</strong><br> mới tại đây
						</div> <!-- LAYER -->
						<div class="tp-caption sft" data-x="center" data-hoffset="0"
							...
							style="z-index: 6">
							<a href="#" class="btn-u btn-brd btn-brd-hover btn-u-light">Có gì mới >></a>
						</div>
					</li>
					<!-- END SLIDE -->
					...
					<li class="revolution-mch-1" data-transition="fade"
						...
						<div class="tp-caption revolution-ch3 sft start" data-x="center"
							...
							data-easing="Back.easeInOut" data-endeasing="Power1.easeIn"
							data-endspeed="300">
							Liên tục <strong>bắt kịp</strong> Trends
						</div> <!-- LAYER -->
						<div class="tp-caption revolution-ch4 sft" data-x="center"
							...
							Có thể bạn chưa biết.<br> Quần áo và phụ kiện tại Real MEN liên tục thay đổi từng ngày
						</div> <!-- LAYER -->
						<div class="tp-caption sft" data-x="center" data-hoffset="0"
							...
							data-endeasing="Power1.easeIn" data-captionhidden="off"
							style="z-index: 6">
							<a href="#" class="btn-u btn-brd btn-brd-hover btn-u-light">Thủ ngay >></a>
						</div>
					</li>
					<!-- END SLIDE -->
					...
					<li class="revolution-mch-1" data-transition="fade"
						...
						<div class="tp-caption revolution-ch4 sft" data-x="right"
							...
							data-endeasing="Power1.easeIn" data-captionhidden="off"
							style="z-index: 6">
							Một chiếc đồng hồ cũng đủ để nói lên<br>sự lịch lãm
						</div> <!-- LAYER -->
						<div class="tp-caption sft" data-x="right" data-hoffset="0"
							...
							data-endeasing="Power1.easeIn" data-captionhidden="off"
							style="z-index: 6">
							<a href="#" class="btn-u btn-brd btn-brd-hover btn-u-light">Ghé thăm>></a>
						</div>
					</li>
					<!-- END SLIDE -->
					...
					<li class="revolution-mch-1" data-transition="fade"
						...
						<div class="tp-caption revolution-ch5 sft start" data-x="right"
							...
							data-easing="Back.easeInOut" data-endeasing="Power1.easeIn"
							data-endspeed="300">
							<strong>Bộ sưu tập</strong> quần Jeans
						</div> <!-- LAYER -->
						<div class="tp-caption revolution-ch4 sft" data-x="right"
							data-hoffset="-14" data-y="210" data-speed="1400"
							data-start="2000" data-easing="Power4.easeOut"
							data-endspeed="300" data-endeasing="Power1.easeIn"
							data-captionhidden="off" style="z-index: 6">
							Một bộ sưu tập quần Jeans.<br> Bạn đã có chưa?
						</div> <!-- LAYER -->
						<div class="tp-caption sft" data-x="right" data-hoffset="0"
							data-y="300" data-speed="1600" data-start="2800"
							data-easing="Power4.easeOut" data-endspeed="300"
							data-endeasing="Power1.easeIn" data-captionhidden="off"
							style="z-index: 6">
							<a href="#" class="btn-u btn-brd btn-brd-hover btn-u-light">Thử ngay>></a>
						</div>
					</li>
					<!-- END SLIDE -->
				</ul>
		...
		<div class="container content-md">
						...
						<div class="illustration-v1 illustration-img1">
							<div class="illustration-bg">
								<div class="illustration-ads ad-details-v1">
									<h3>
										CHÀO XUÂN <strong>SALE</strong> 30% - 60% <strong>OFF</strong>
									</h3>
									<a class="btn-u btn-brd btn-brd-hover btn-u-light" href="#">Ghé thăm</a>
								</div>
							</div>
						</div>
					</div>
						...
						<a class="illustration-v1 illustration-img2" href="#"> <span
							class="illustration-bg"> <span
								class="illustration-ads ad-details-v2"> <span
									class="item-time">Thu 2019</span> <span class="item-name">Lacoste</span>
							</span>
						</span>
						</a>
					</div>
			...
			<div class="heading heading-v1 margin-bottom-20">
				...
				<p>Là một tín đồ trong lĩnh vực quần áo dành riêng cho nam, Real MEN liên tục đưa ra những sản
				phẩm uy tín, chất lượng, đi kèm với đó là sự lịch lãm không kém phần long trọng dành riêng
				cho nam giới.</p>
			</div>
							...
							<span class="illustration-bg"> <span
								class="illustration-ads"> <span
									class="illustration-v3-category"> <span
										class="product-category">Quần áo</span> <span
										class="product-amount">1256 Sản phẩm</span>
								</span>
							</span>
						</span>
						</a>
					...
					<div class="overflow-h">
						<a class="illustration-v3 illustration-img2"
							...
							<span class="illustration-bg"> <span
								class="illustration-ads"> <span
									class="illustration-v3-category"> <span
										class="product-category">Giày</span> <span
										class="product-amount">200 Sản phẩm</span>
								</span>
							</span>
						</span>
						</a>
					...
					<div class="overflow-h">
						<a class="illustration-v3 illustration-img3"
							...
							<span class="illustration-bg"> <span
								class="illustration-ads"> <span
									class="illustration-v3-category"> <span
										class="product-category">Đồng hồ</span> <span
										class="product-amount">56 Sản phẩm</span>
								</span>
							</span>
						</span>
						</a>
					...
					<div class="col-md-3 col-sm-6 md-margin-bottom-30">
						<div class="product-img">
							...
							<a class="product-review"
								href="${pageContext.request.contextPath }/product/detail?id=${p.id}">Review</a>
							<a class="add-to-cart"
								href="${pageContext.request.contextPath }/product/detail?id=${p.id}"><i
				...
				<div id="carousel-example-generic-v5" class="carousel slide"
					...
					<div class="carousel-inner">
						<div class="item active">
							<p>
								Mỗi ngày, Real MEN có thêm 200 thành viên mới.
								<br>Đăng kí ngay
								 <a href="${pageContext.request.contextPath }/login">Tại đây</a>
							<p>
						...
						<div class="item">
							<p>Thỏa sức mua sắm tại Real MEN. Liên tục tích điểm để nhận hàng ngàn ưu đãi</p>
							<ul class="list-inline twitter-icons">
								<li><a href="#"><i class="fa fa-reply"></i></a></li>
								<li><a href="#"><i class="fa fa-retweet"></i></a></li>
								<li><a href="#"><i class="fa fa-star"></i></a></li>
						...
						<div class="item">
							<p>
								Cam kết 100% về chất lượng sản phẩm.
							</p>
							<ul class="list-inline twitter-icons">
								<li><a href="#"><i class="fa fa-reply"></i></a></li>
								<li><a href="#"><i class="fa fa-retweet"></i></a></li>
			...
			<div class="row margin-bottom-60">
				<div class="col-md-4 product-service md-margin-bottom-30">
					...
					<div class="product-service-in">
						...
						<p>Giờ đây, bạn có thể mua sắm trực tuyến bất cứ đâu...</p>
					</div>
				</div>
				<div class="col-md-4 product-service md-margin-bottom-30">
					<div class="product-service-heading">
					...
					<div class="product-service-in">
						...
						<p>Chúng tôi luôn lấy những phản hổi từ khách hàng để nâng cao chất lượng dịch vụ...</p>
					</div>
				</div>
				<div class="col-md-4 product-service">
					...
					<div class="product-service-in">
						...
						<p>Chúng tôi cam kết miễn phí hoàn toàn phí đổi trả...</p>
					</div>
				</div>
			</div>
			<!--/end row-->
		...
		<div class="collection-banner">
			<div class="container">
				<div class="col-md-7 md-margin-bottom-50">
					<h2>Làm mới bộ sưu tập</h2>
					<p>
						Khi mua sắm theo bộ sưu tập, bạn có thể nhận ưu đãi lên đến 50%
					</p>
					<br> <a href="#"
						class="btn-u btn-brd btn-brd-hover btn-u-light">Ngó thử >></a>
				</div>
				<div class="col-md-5">
					<div class="overflow-h">
