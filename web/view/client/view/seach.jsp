...
<div class="col-md-3 filter-by-block md-margin-bottom-60">
							...
							<div id="collapseTwo" class="panel-collapse collapse in">
								<div class="panel-body">
									<ul class="list-unstyled checkbox-list">
										...
										<br>
										<a href="${pageContext.request.contextPath }/product/category?cate_id=2" > Trẻ Con</a>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="panel-heading">
								<h2 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion-v5"
										href="#collapseFive"> Màu sắc <i class="fa fa-angle-down"></i>
									</a>
								</h2>
							</div>
							...
							<div class="panel-heading">
								<h2 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion-v6"
										href="#collapseSix"> Chất lượng <i class="fa fa-angle-down"></i>
									</a>
								</h2>
							</div>
					...
					<!--/end panel group-->
					<button type="button"
						class="btn-u btn-brd btn-brd-hover btn-u-lg btn-u-sea-shop btn-block">Đặt lại</button>
				</div>
