...
<body class="header-fixed">
	<div class="wrapper">
		...
		<div class="breadcrumbs-v4">
			<div class="container">
				<span class="page-name">Danh mục sản phẩm</span>
				<h1>
					Liên tục <span class="shop-green">update</span>
				</h1>
				...
				<div class="col-md-9">
								...
								<li class="sort-list-btn">
									...
									<div class="btn-group">
										...
										<ul class="dropdown-menu" role="menu">
											...
											<li><a href="#">Sản phẩm chạy nhất tuần</a></li>
										...
										<div class="overflow-h margin-bottom-5">
											...
											<ul class="list-inline add-to-wishlist margin-bottom-20">
												<li class="wishlist-in"><i class="fa fa-heart"></i> <a
													href="${pageContext.request.contextPath }/product/detail?id=${p.id}">Yêu thích</a>
												</li>
											</ul>
											<a
					...
					<div class="text-center">
						<ul class="pagination pagination-v2">
							...
							<li class="active"><a href="product-list.jsp?page=1">1</a></li>
							<li><a href="product-list.jsp?page=2>2</a></li>
							<li><a href="product-list.jsp?page=3>3</a></li>
